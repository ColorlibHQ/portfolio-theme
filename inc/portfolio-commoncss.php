...
// enqueue css
function portfolio_common_custom_css(){
    
    wp_enqueue_style( 'portfolio-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= portfolio_opt( 'portfolio_theme_color' ) != '#131313' ? portfolio_opt( 'portfolio_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= portfolio_opt( 'portfolio_book_btn_color' ) != '#131313' ? portfolio_opt('portfolio_book_btn_color') : '';
		$bookBtnHoverBgColor     	= portfolio_opt( 'portfolio_book_btn_hvr_bg_color' ) != '#131313' ? portfolio_opt('portfolio_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = portfolio_opt( 'portfolio_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = portfolio_opt( 'portfolio_navbar_bg_color' ) != '#082b49' ? portfolio_opt( 'portfolio_navbar_bg_color') : '';
		$headerTop_col     		  = portfolio_opt( 'portfolio_top_header_color' );

		$headerTopBg      		  = portfolio_opt( 'portfolio_top_header_bg_color');
		$headerBg          		  = portfolio_opt( 'portfolio_header_bg_color') != '#ffffff' ? portfolio_opt( 'portfolio_header_bg_color') : '';
		$menuColor          	  = portfolio_opt( 'portfolio_header_menu_color' ) != '#131313' ? portfolio_opt('portfolio_header_menu_color') : '';
		$menuHoverColor           = portfolio_opt( 'portfolio_header_menu_hover_color' ) != '#808080' ? portfolio_opt('portfolio_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = portfolio_opt( 'portfolio_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = portfolio_opt( 'portfolio_header_drop_menu_bg_color' ) != '#ffffff' ? portfolio_opt('portfolio_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = portfolio_opt( 'portfolio_dropdown_menu_color' ) != '#131313' ? portfolio_opt('portfolio_dropdown_menu_color') : '';
		$dropMenuHovColor         = portfolio_opt( 'portfolio_dropdown_menu_hover_color' ) != '#808080' ? portfolio_opt('portfolio_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = portfolio_opt( 'portfolio_footer_widget_bg_color' );
		$footerwHeadColor   	  = portfolio_opt('portfolio_footer_widget_heading_color');
		$footerwTextColor   	  = portfolio_opt('portfolio_footer_widget_text_color');
		$footerwanchorcolor 	  = portfolio_opt('portfolio_footer_widget_anchor_color') != '#ffffff' ? portfolio_opt('portfolio_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = portfolio_opt('portfolio_footer_widget_anchor_hover_color') != '#ffffff' ? portfolio_opt('portfolio_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = portfolio_opt('portfolio_fof_bg_color');
		$foftonecolor			  = portfolio_opt('portfolio_fof_textone_color');
		$fofttwocolor			  = portfolio_opt('portfolio_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = portfolio_opt('portfolio_footer_widget_anchor_color') != '#9e9e9e' ? portfolio_opt('portfolio_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .portfolio_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .portfolio_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'portfolio-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'portfolio_common_custom_css', 50 );